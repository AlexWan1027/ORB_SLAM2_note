...
// bundle adjustment优化对象： Map中所有的MapPoints和关键帧
...
// BA优化
// 主要是3D-2D 最小化重投影误差 e = (u,v) - project(Tcw*Pw) 
                                 ...
                                 int nIterations, bool* pbStopFlag, const unsigned long nLoopKF, const bool bRobust)
{
    ...
    for(size_t i=0; i<vpMP.size(); i++)
    {
        ...
        if(pMP->isBad())
            continue;
	// g2o::VertexSBAPointXYZ()，MapPoint的世界坐标系下的坐标
...
int Optimizer::PoseOptimization(Frame *pFrame)
{
    ...
    // 开始优化，总共优化四次，每次优化后，将观测分为outlier和inlier，而且outlier不参与下次优化
